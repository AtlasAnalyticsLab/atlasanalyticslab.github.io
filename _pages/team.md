...
<!--
  ...
  Purpose:
    ...
    Shows PI, postdocs, PhD students, Master's students, visiting students/interns, collaborators, and alumni.
...
<div markdown="0">
{% include team-grid.html members=site.data.visiting_students show_role=true %}
</div>
